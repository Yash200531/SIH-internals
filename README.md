...
<div align="center">
  <img src="patient-case-taking-platform/assets/Screenshot (699).png" alt="Patient Case-Taking Platform — voice-first, multilingual, consent-driven clinical documentation" width="100%"/>
</div>
...
<table>
  <tr>
    <td width="50%" align="center">
      <img src="patient-case-taking-platform/assets/Onboarding.png" alt="Patient onboarding screen inviting the patient to describe what is bothering them" width="100%"/>
      <br/><strong>1. Start with the patient's voice</strong>
    </td>
    <td width="50%" align="center">
      <img src="patient-case-taking-platform/assets/Screenshot (697).png" alt="Patient speech organized into structured clinical information" width="100%"/>
      <br/><strong>2. Organize the patient's words</strong>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="patient-case-taking-platform/assets/Onbarding-Overview.png" alt="Three-step patient workflow from speaking to meeting the doctor" width="100%"/>
      <br/><strong>3. Connect the patient to care</strong>
    </td>
    <td width="50%" align="center">
      <img src="patient-case-taking-platform/assets/Screenshot (694).png" alt="Staff OCR document verification screen with review actions" width="100%"/>
...
<div align="center">
  <img src="patient-case-taking-platform/assets/clinical-workflow.svg" alt="Primary clinical workflow: patient speaks, AI structures with provenance, clinician verifies before signing" width="800"/>
</div>
...
<div align="center">
  <img src="patient-case-taking-platform/assets/uses-benefits.svg" alt="Uses and benefits: target reductions in documentation time and missing data, clinician oversight, ABDM nativeness, safety gate" width="940"/>
</div>
...
| Document | Purpose |
|----------|---------|
| [`SETUP.md`](patient-case-taking-platform/SETUP.md) | Fresh-device setup, local development and dashboard usage |
| [`CONTEXT-GRAPH.md`](patient-case-taking-platform/CONTEXT-GRAPH.md) | Repository & system context |
| [`BUILD-ROADMAP.md`](patient-case-taking-platform/docs/plans/BUILD-ROADMAP.md) | Phased delivery plan |
| [`PHASE-6-RED-FLAG-TRIAGE.md`](patient-case-taking-platform/docs/plans/PHASE-6-RED-FLAG-TRIAGE.md) | In-progress deterministic triage and durable alert implementation plan |
| [`PHASE-7-DOCUMENT-INGESTION-OCR.md`](patient-case-taking-platform/docs/plans/PHASE-7-DOCUMENT-INGESTION-OCR.md) | Phase 7 implementation ledger, safety invariants and remaining rollout gates |
| [`PHASE-8-SUMMARY-WORKFLOW.md`](patient-case-taking-platform/docs/plans/PHASE-8-SUMMARY-WORKFLOW.md) | Mock-only evidence-linked summary workflow and implementation ledger |
| [`PRE-PHASE-9-PATIENT-DASHBOARD-AND-S2S.md`](patient-case-taking-platform/docs/plans/PRE-PHASE-9-PATIENT-DASHBOARD-AND-S2S.md) | Patient dashboard/services completion contract and verification ledger |
| [`PHASE-9-SEARCH-RETRIEVAL-LONGITUDINAL-CONTEXT.md`](patient-case-taking-platform/docs/plans/PHASE-9-SEARCH-RETRIEVAL-LONGITUDINAL-CONTEXT.md) | Reviewed-record search, longitudinal context and measured implementation ledger |
| [`PATIENT-PORTAL-API.md`](patient-case-taking-platform/docs/contracts/PATIENT-PORTAL-API.md) | Self-scoped consent, intake, upload, timeline and signed-report API |
| [`ADR-009`](patient-case-taking-platform/docs/architecture/decisions/ADR-009-PATIENT-SELF-SCOPE-AND-MOCK-TTS.md) | Patient identity boundary and deterministic mock TTS decision |
| [`ADR-010`](patient-case-taking-platform/docs/architecture/decisions/ADR-010-REBUILDABLE-CLINICAL-SEARCH.md) | Rebuildable, human-reviewed search projection decision |
| [`PHASE-9-SEARCH-RUNBOOK.md`](patient-case-taking-platform/docs/operations/PHASE-9-SEARCH-RUNBOOK.md) | Search outage, reconciliation, tenant repair and benchmark procedure |
| [`medikiosk-change-ledger.html`](patient-case-taking-platform/review/medikiosk-change-ledger.html) | Evidence-led Phase 5–9 engineering review |
| [`SYSTEM-ARCHITECTURE.md`](patient-case-taking-platform/docs/architecture/SYSTEM-ARCHITECTURE.md) | Target architecture & request flows |
| [`TRAFFIC-CONTROL-AND-MODEL-ROUTING.md`](patient-case-taking-platform/docs/architecture/TRAFFIC-CONTROL-AND-MODEL-ROUTING.md) | NGINX, gateway, uploads, provider routing & implementation slices |
| [`SERVICE-BOUNDARIES.md`](patient-case-taking-platform/docs/architecture/SERVICE-BOUNDARIES.md) | Logical contexts, MVP deployables & extraction triggers |
| [`DATA-OWNERSHIP.md`](patient-case-taking-platform/docs/architecture/DATA-OWNERSHIP.md) | Sources of truth & storage rules |
| [`DATA-MODEL.md`](patient-case-taking-platform/docs/architecture/DATA-MODEL.md) | Conceptual Postgres, MongoDB, object & AYUSH model |
| [`EVENT-CATALOG.md`](patient-case-taking-platform/docs/contracts/EVENT-CATALOG.md) | Async event conventions |
| [`RESILIENCE-PATTERNS.md`](patient-case-taking-platform/docs/operations/RESILIENCE-PATTERNS.md) | Dependency fallbacks, retry, cache & rollout policy |
| [`CLINICAL-AI-SAFETY.md`](patient-case-taking-platform/docs/safety/CLINICAL-AI-SAFETY.md) | Clinical AI safety gates |
| [`SECURITY-AND-PRIVACY.md`](patient-case-taking-platform/docs/security/SECURITY-AND-PRIVACY.md) | Consent, access & PHI controls |
...
1. Read [`CONTEXT-GRAPH.md`](patient-case-taking-platform/CONTEXT-GRAPH.md) and relevant subsystem `README.md`
...
Apache License 2.0 — see [`LICENSE`](patient-case-taking-platform/LICENSE) for details.
